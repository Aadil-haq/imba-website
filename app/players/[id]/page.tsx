                ...
                {player.teamsHistory.map(t => (
                  <Link key={t.id} href={`/teams/${t.slug}`} style={{ textDecoration: 'none' }}>
                    <span style={{
                      ...
                      {t.logo
                        ? <img src={t.logo} alt="" style={{ width: '16px', height: '16px', objectFit: 'contain', borderRadius: '50%', backgroundColor: '#fff', flexShrink: 0 }} />
                    ...
                    <tr key={`${s.season}-${s.teamId}`} style={{ backgroundColor: i % 2 === 0 ? '#1a1a1a' : '#141414', borderBottom: '1px solid #222' }}>
                      ...
                      <td style={{ padding: '11px 10px', whiteSpace: 'nowrap' }}>
                        <Link href={`/teams/${s.teamSlug}`} style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '6px' }}>
                          {s.teamLogo
                            ? <img src={s.teamLogo} alt="" style={{ width: '18px', height: '18px', objectFit: 'contain', borderRadius: '50%', backgroundColor: '#fff', flexShrink: 0 }} />
                  ...
                  {player.teamsHistory.map(t => (
                    <Link key={t.id} href={`/teams/${t.slug}`} style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingBottom: '12px', borderBottom: '1px solid #222' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        {t.logo
                          ? <img src={t.logo} alt="" style={{ width: '32px', height: '32px', objectFit: 'contain', borderRadius: '50%', backgroundColor: '#fff', flexShrink: 0 }} />
                    ...
                    <tr key={game.gameId} style={{ backgroundColor: i % 2 === 0 ? '#1a1a1a' : '#141414', borderBottom: '1px solid #222' }}>
                      ...
                      <td style={{ padding: '11px 10px', whiteSpace: 'nowrap' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                          {game.teamLogo
                            ? <img src={game.teamLogo} alt="" style={{ width: '16px', height: '16px', objectFit: 'contain', borderRadius: '50%', backgroundColor: '#fff', flexShrink: 0 }} />
                      ...
                      <td style={{ padding: '11px 10px', whiteSpace: 'nowrap' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                          {game.oppLogo
                            ? <img src={game.oppLogo} alt="" style={{ width: '16px', height: '16px', objectFit: 'contain', borderRadius: '50%', backgroundColor: '#fff', flexShrink: 0 }} />
